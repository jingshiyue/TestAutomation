...
data: {}
    ...
    {"reqId":"21d7a0a874b511eabf1f9c305b5da1f9","status":0,"msg":"Success"}
    """
    CASE_TYPE = (
        ("单接口", "单接口"),
        ("单接口", "流程"),
    ...
    body = models.TextField('请求体列表', default=DEFAULT_REQUEST_TEXT,blank=True,
                            help_text='单接口的请求体列表,  流程测试不填这项！')
    # case_file = models.FileField('用例测试脚本',upload_to='TestCase.modular_name',blank=True,help_text='流程测试,请上传流程测试脚本！')
    file_path = models.CharField("启动脚本路径", max_length=128, help_text="e.g xx/xx/xx",blank=True)
