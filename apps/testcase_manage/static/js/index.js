...
(function ($) {
    ...
    $.learunindex = {
        load: function () {
            ...
            $("#content-wrapper").find('.mainContent').height($(window).height() - 140);
        ...
        loadMenu: function () {
            ...
            $.each(data, function (i) {
                var row = data[i];
                _html += '<li style="margin:1px">';
                _html += '<a style=font-size:18px;>' + row + '</a>'
                _html += '</li>'
                }
            );
            ...
            $("#sidebar-menu li a").click(function () {
                ...
                if($(this).parent().hasClass("active")){
                    $(this).siblings(".treeview-menu").find("li").each(function(index){
                        var _this = $(this);
                        setTimeout(function(){
                            _this.css("transform","translateX(-40px)")
                        },index*10)
                    });
                }else{
                    $(this).siblings(".treeview-menu").find("li").each(function(index){
                        var _this = $(this);
                        setTimeout(function(){
                            _this.css("transform","translateX(0)")
                        },index*50 + 200)
                    });
                }
    ...
    function dynamic(p_this){
        p_this.parent().siblings("li").find(".treeview-menu").find("li").each(function(){
            var _this = $(this);
            setTimeout(function(){
                _this.css("transform","translateX(-40px)")
            },10)
